...
public class MainClass {
    ...
    public static void main(String[] args) {
        ...
        Scanner scan = new Scanner(System.in); //Scanner to read from the console
            //student object 
        ...
        System.out.println("enter Freshman GPA:");
        std2.setGPA(scan.nextShort()); //write freshman GPA
        System.out.println("enter Senior GPA:");
        std3.setGPA(scan.nextShort()); //write senior GPA
